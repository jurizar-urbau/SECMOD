...
<%						
	if( request.getParameter( "id" ) != null || "add".equals( request.getParameter( "mode" )) || "addModal".equals( request.getParameter( "mode" ))  ){
		...
		PackingBean bean = options_main.get( id );
...
<html lang="en">
	<head>
		...
		<script>
			function back(){
				location.replace( "packing.jsp?idproucto=<%= idproducto %>");
			}			
		</script>
	</head>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-angle-right"></i> DETALLE PACKING</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          			
          			    <div class="form-panel">
          			   
                  	  <h4 class="mb"><i class="fa fa-angle-left"></i><a href="packing.jsp?idproucto=<%= idproducto %>">&nbsp;Regresar</a> </h4>
                      ...
                      <form class="form-horizontal style-form" id="form" name="form">
                      	...
                      	<div class="form-group">                      	
                          	...
                          	<div class="col-sm-10">                 	            	                          
                          		<input type="text" class="form-control" name="name" id="name" value="<%= bean.getNombre() %>">	                          	                          	                          	                          
                          	</div>
                      	</div>
                      	<div class="form-group">                      	
                          	<label class="col-sm-2 col-sm-2 control-label">Coeficiente</label>
                          	<div class="col-sm-10">                 	            	                          
                          		<input type="text" class="form-control" name="multiplicador" id="multiplicador" value="<%= bean.getMultiplicador() %>">	                          	                          	                          	                          
                          	</div>
                      	</div>
    				...
    				var form =$('#form');
        	     	$.ajax({
        		        ...
        		        success: function(msg){		        	
        		        	alert(msg);
        		            location.replace( "packing.jsp?idproducto=<%= idproducto %>" );
        		        },
