...
<%
	...
	String sql =
			"SELECT " +
					...
					sql += " ORDER BY HEAD.BODEGA,HEAD.CORRELATIVO";
                              ...
                              <%
                                ...
                                int grandTotalUnidades = 0;
                              	...
                              	for( ExtendedFieldsBean us : list ){
                              		...
                              		String newFamily = "BODEGA: " + us.getReferenced( "1", "BODEGAS", "NOMBRE" ) + "<BR> Correlativo: " + us.getValue( "4" ) ; 
		                              ...
		                              %>
                              		<tr>
                              		 	  	<td><%=us.getValue( "8" ) + " " + us.getValue( "9" )   %></td>
										  <td><%= us.getValue( "2" ) %></td>
