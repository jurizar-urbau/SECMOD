...
<%						
	if( request.getParameter( "id" ) != null || "add".equals( request.getParameter( "mode" )) || "addModal".equals( request.getParameter( "mode" ))  ){
		...
		TipoMovimientoBean bean = main.get( id );		
...
<html lang="en">
	<head>
		...
		<script>
			function back(){
				location.replace( "tipo_movimiento.jsp");
			}			
		</script>
	</head>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-angle-right"></i> DETALLE MOVIMIENTO</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          			
          			    <div class="form-panel">
          			   
                  	  <h4 class="mb"><i class="fa fa-angle-left"></i><a href="tipo_movimiento.jsp">&nbsp;Regresar</a> </h4>
