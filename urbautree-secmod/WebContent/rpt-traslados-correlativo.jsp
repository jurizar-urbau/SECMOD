...
<%
	...
	sql += " ORDER BY HEAD.BODEGA_DESTINO,HEAD.CORRELATIVO";
                              ...
                              <%
                                ...
                                int grandTotalUnidades = 0;
                              	...
                              	for( ExtendedFieldsBean us : list ){
                              		...
                              		String newFamily = "";
                              		if( "r".equals( tipo ) ) {
                              		 	newFamily = "ORIGEN: " + us.getReferenced( "1", "BODEGAS", "NOMBRE" ) + "<BR> Correlativo: " + us.getValue( "11" );  
								   } else { 
									   	newFamily = "DESTINO: " + us.getReferenced( "2", "BODEGAS", "NOMBRE" ) + "<BR> Correlativo: " + us.getValue( "11" ) ; 
								   } 
                              		
                              		if( !lastFamily.equals(  newFamily )){
                              			printtotals = true;
		                        		if( contador > 0 ){ %>
		                              	<tr>
										  <td></td>
		                              ...
		                              <%
		                               ...
		                               lastFamilyName = newFamily;
		                               %>
		                              	<tr>
		                              	<td colspan="8"><b><div style="text-transform: uppercase;"><%= lastFamily %></div></b><hr></td>
		                              ...
		                              %>
                              		<tr>
                              		 	  	<td><%=us.getValue( "7" ) + " " + us.getValue( "8" )   %></td>
										  <td><%= us.getValue( "3" ) %></td>
