...
<script>
	function regresar(){
		...
		<% } else { %>
			location.replace( "salida-bodega.jsp" );	
		<% } %>
	}
</script>
<style>
...
<table>
	<tr>
		<td><b>SALIDA</b></td><td>:</td><td><%= head.getValue( "CORRELATIVO") %></td>
	</tr>
	<tr>
	...
	<tr>
		<td><b>OBSERVACIONES</b></td><td>:</td><td><%= head.getValue( "OBSERVACIONES") %></td>
	</tr>
