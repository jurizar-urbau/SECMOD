  ...
  <section id="container" >
                  ...
                  <div class="col-lg-3 ds col-md-3 col-sm-3">
                   ...
                   <div class="desc">
                      ...
                      <form name="saleform" id="saleform" method="POST">
                           ...
                           Observaciones:<br/><textarea type='text' name='observaciones' id='observaciones' ></textarea>
	...
	<script>
		...
		function searchProducts( q ){
			...
			var totalproducts = 0;
			  $.get( "./bin/searchp?q=" + q + "&bodega=" + selected_bodega_id, null, function(response){
				$('#loadingDIV').hide();
				 $('#noresultsDIV').hide();
	    	     	...
	    	     	$.ajax({
	    		        ...
	    		        success: function(msg){
	    		        	...
	    		        	if( !msg.startsWith('error') ){
	    		        		if( confirm( "Desea imprimir la salida?" ) ){
	    		        			location.replace( 'rpt-salidas-bodega.jsp?id=' + messages[ 0 ] );
	    		        		} else {
	    		        			location.reload();
	    		        		}
	    		        	} else {
