...
<%
	...
	ExtendedFieldsBaseMain rm = new ExtendedFieldsBaseMain( "PRESTAMOS", 
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-angle-right"></i> Detalle de prestamo</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          			
          			    <div class="form-panel">
          			   		<h4 class="mb"><i class="fa fa-angle-left"></i><a href="prestamos.jsp">&nbsp;Regresar</a> </h4>
          			   		<form class="form-horizontal style-form" id="form" name="form">
		                      	...
		                      	<input type="hidden" name="tablename" id="tablename" value="<%= EncryptUtils.base64encode( "PRESTAMOS" ) %>"></input>
                         ...
                         <div class="form-actions">
					            ...
					            <button class="btn" onclick="location.replace('prestamos.jsp')">Cancelar</button>
					     </div>                                                                                                      
                  </div>
          		</div>
    			...
    			var form =$('#form');
    	     	$.ajax({
    		        ...
    		        success: function(msg){		        	
    		        	alert(msg);
    		            location.replace( "prestamos.jsp" );
    		        },
