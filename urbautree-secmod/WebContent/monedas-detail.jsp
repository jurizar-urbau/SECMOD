          ...
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                  	  ...
                  	  <h4 class="mb"><i class="fa fa-angle-left"></i><a href="monedas.jsp">&nbsp;Regresar</a> </h4>
                      ...
                      <form class="form-horizontal style-form" method="POST" id="form" name="form">
                      	...
                      	<div class="form-group">                      	
                          	...
                          	<div class="col-sm-10">                          	            
								<input type="text" class="form-control" name="symbol" id="symbol" value="<%= bean.getSimbolo() %>">	                          	                                                                                                  
                          	</div>
                      	</div>
