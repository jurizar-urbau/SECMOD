      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-angle-right"></i> DETALLE PRECIO</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          			
          			    <div class="form-panel">
          			   
                  	  <h4 class="mb"><i class="fa fa-angle-left"></i><a href="precios.jsp">&nbsp;Regresar</a> </h4>
                      ...
                      <form class="form-horizontal style-form" method="POST" id="form" name="form">
                      	...
                      	<div class="form-group">                      	
                          	...
                          	<div class="col-sm-10">                          	
                          		<input type="text" class="form-control" name="coeficiente" id="coeficiente" value="<%= bean.getCoeficiente() %>">
	...
	<script>
		...
		//twitter bootstrap script
			...
			if(mode === "remove"){
				...
				$coeficiente.attr('disabled','disabled');
