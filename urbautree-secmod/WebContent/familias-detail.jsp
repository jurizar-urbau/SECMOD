...
<%	
	if( request.getParameter( "id" ) != null || "add".equals( request.getParameter( "mode" )) || "addModal".equals( request.getParameter( "mode" ))  ){
		...
		FamiliasMain rm = new FamiliasMain();
		FamiliaBean bean = rm.get( id );
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-angle-right"></i> AGREGAR FAMILIA</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          			
          			    <div class="form-panel">
          			   
                  	  <h4 class="mb"><i class="fa fa-angle-left"></i><a href="familias.jsp">&nbsp;Regresar</a> </h4>
                      ...
                      <form class="form-horizontal style-form" id="form" name="form">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                          	...
	                          	<%}else{%>
	                          		<input type="text" class="form-control" name="name" id="name" disabled value="<%= bean.getNombre() %>">	                          		
	                          	<%}%>   	                                  
                              </div>
                          </div>
