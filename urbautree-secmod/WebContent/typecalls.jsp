...
<html lang="en">
	...
	<%
		TypeCallMain vm = new TypeCallMain();
		...
		ArrayList<TypeCallBean> list = vm.getItems();
		int total_regs = -1;
		
		if( list.size() > 0 ){
			total_regs = ((TypeCallBean)list.get( 0 )).getTotal_regs();
		}
	%>
	<script>
	var table = "typecalls";
          	...
          	<div class="row mt">
          		...
          		<div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Tipos de Llamadas </h4>
	                  	  	  <hr>
	                  	  	  <thead>
                              <tr>
                                  <th class="hidden-phone">Typo</th>
