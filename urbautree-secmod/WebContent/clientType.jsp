...
<html lang="en">
	...
	<%
		ClientTypeMain vm = new ClientTypeMain();
		...
		if( list.size() > 0 ){
			total_regs = ((ClientTypeBean)list.get( 0 )).getTotal_regs();
		}
	%>
	<script>
		var table = "clientType";
		function edit( id ){
			location.replace( "clientType-detail.jsp?mode=edit&id="+id);
		}
          	...
          	<div class="row mt">
          		...
          		<div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Tipos de Cliente </h4>
	                  	  	  <hr>
	                  	  	  <thead>
                              <tr>
                              ...
                              <tbody>
                              <%
                              	for( ClientTypeBean us : list ){
                              %>
                              <tr>
                                  <td class="hidden-phone"><%= us.getType() %></td>
                                  <td>
