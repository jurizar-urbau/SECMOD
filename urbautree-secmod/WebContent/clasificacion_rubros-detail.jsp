...
<%						
	if( request.getParameter( "id" ) != null || "add".equals( request.getParameter( "mode" )) || "addModal".equals( request.getParameter( "mode" ))  ){
		...
		ClasificacionRubroBean bean = main.get( id );		
...
<html lang="en">
	<head>
		...
		<script>
			function back(){
				location.replace( "clasificacion_rubros.jsp");
			}			
		</script>
	</head>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<h3><i class="fa fa-angle-right"></i> DETALLE DE CLASIFICACION DE RUBRO</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          			
          			    <div class="form-panel">
          			   
                  	  <h4 class="mb"><i class="fa fa-angle-left"></i><a href="clasificacion_rubros.jsp">&nbsp;Regresar</a> </h4>
