          			    	...
          			    	<form class="form-horizontal style-form" id="form" name="form" >
		                          	...
		                          	<div class="form-group">
		                            	<label class="col-sm-2 col-sm-2 control-label">Saldo</label> 
		                              	<div class="col-sm-10">
			                          		<input type="text" class="form-control" name="SALDO" id="SALDO"  value="<%= Util.getTotalComprasProveedores( request.getParameter( "proveedorid" )  ) - Util.getTotalComprasProveedoresPayments( request.getParameter( "ID_CLIENTE" )  )  %>" readonly>
		                              	</div>
		                          	</div>
		                          	<!-- div class="form-group">
