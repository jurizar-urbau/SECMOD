          			     ...
          			     <hr>
          			    	<form class="form-horizontal style-form" id="form" name="form" >
		                            	...
		                            	<label class="col-sm-2 col-sm-2 control-label">Cliente</label> 
		                              	<div class="col-sm-10">
			                          		<input type="text" class="form-control" name="proveedordisplay" id="proveedordisplay"  value="<%= request.getParameter("proveedordisplay")  %>" readonly>
			                          		<input type="hidden" name="proveedorid" id="proveedorid" value="<%= request.getParameter( "proveedorid" )  %>">	                          	                          
		                              	</div>
		                          	</div>
		                          	<div class="form-group">
		                            	<label class="col-sm-2 col-sm-2 control-label">Saldo</label> 
		                              	<div class="col-sm-10">
			                          		<input type="text" class="form-control" name="SALDO" id="SALDO"  value="<%= Util.getTotalComprasProveedores( request.getParameter( "proveedorid" )  ) - Util.getTotalComprasProveedoresPayments( request.getParameter( "proveedorid" )  )  %>" readonly>
		                              	</div>
		                          	</div>
		                          	<!-- div class="form-group">
		...
		$(function() {
    		$("#next").click(function(){
    			var form =$('#form');
	     		$.ajax({
		     		type:'POST',
		 			url: './bin/PayCompraProveedor',
		 			data: form.serialize(),
		 			dataType: "text",		 			
			        success: function(msg){				        	
			        	alert(msg);
			        	location.replace( "pago-compra-proveedor.jsp");
			        },
