...
<html lang="en">
	...
	<script>
		function edit( id ){
			location.replace( "correlativos-detail.jsp?mode=edit&id="+id);
		}
		function removereg( id ){
			location.replace( "correlativos-detail.jsp?mode=remove&id="+id);
		}
		function view( id ){
			location.replace( "correlativos-detail.jsp?mode=view&id="+id);
		} 
		function add(){
			location.replace( "correlativos-detail.jsp?mode=add" );
		}
	</script>
	</head>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          	...
          	<div class="row mt">
          		...
          		<div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Correlativos </h4>
	                  	  	  <hr>
	                  	  	  <thead>
                              <tr>
		...
		%>
					  ...
					  <% if( backButton ) {%>
					  <li class="previous">
					    		<a href="correlativos.jsp?q=<%= request.getParameter("q") %>&from=<%= from - Constants.ITEMS_PER_PAGE  %>">
					  ...
					  <% } %>
					    <% if( forwardButton ){  %>
					    <li class="next">
					    	<a href="correlativos.jsp?q=<%= request.getParameter("q") %>&from=<%= end  %>">
